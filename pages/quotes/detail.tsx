...
import stylesQuote from "../../styles/Quote.module.css";
...
const QuoteDetail = () => {
     ...
     return (
          <Layout pageTitle="Quote Detail">
               ...
               <div className={stylesQuote.contentWrapper}>
                              ...
                              <div className="grid grid-cols-12 gap-6">
                                   <div className="col-span-8">
                                        <div className={styles.cardContent}>
                                             ...
                                             <h1 className={stylesQuote.title + " text-blue-1"}>“Don’t stop when you’re tired. Stop when you’re done.”</h1>
                                             <Gap height={10} />
                                        ...
                                        <div className={styles.cardContent}>
                                             <div className="flex justify-between items-center">
                                                  <h1 className={stylesQuote.moreTitle}>Comments</h1>
                                                  <div className="inline-flex items-center" style={{ cursor: "pointer" }} onClick={() => setShowAdd(true)}>
                                             ...
                                             <div className="flex justify-between">
                                                  <div className="flex items-start">
                                                       <img src="/assets/images/commentSample.jpg" className={stylesQuote.imageComment} alt="imageComment" />
                                                       <Gap width={20} />
                                                       <div>
                                                            <h1 className={"text-blue-1 " + stylesQuote.nameComment}>Vincent Hadinata</h1>
                                   ...
                                   <div className="col-span-4">
                                        <div className={styles.cardContent}>
                                             <h1 className={stylesQuote.moreTitle}>More Quotes</h1>
                                             <Gap height={10} />
                                             <hr />
                                             <Gap height={15} />
                                             <h1 className={stylesQuote.moreTitle + " text-blue-1 " + stylesQuote.moreHeight}>Your time is limited, so don’t waste it living someone else without you</h1>
                                             <Gap height={5} />
